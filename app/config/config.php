...
$app->set('flight.base_url', '/exam_final_s3/',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
return [
	...
	'database' => [
		...
		// 'password' => '9u0np1ua',  // Database password (never commit real passwords)
		'password' => '',
